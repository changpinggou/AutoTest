...
set(CMAKE_XCODE_ATTRIBUTE_ARCHS[sdk=iphoneos*] "\$\{ARCHS_STANDARD\}")
...
set(CMAKE_XCODE_ATTRIBUTE_ARCHS[sdk=iphonesimulator*] "\$\{ARCHS_STANDARD\}")
...
if("${IOS_VARIANT}" STREQUAL "MACCATALYST")
  ...
  set(IOS_DEPLOYMENT_SDK_VERSION "14.0") # WARN: Many system APIs (such as camera) were only supported since 14.0, so we drop the support of 13.0 (macOS 10.15)
endif()
