...
toolchain_table = [
    ...
    Toolchain("android-ndk-r13b-api-15-armeabi-v7a-neon", 'Unix Makefiles'),
    Toolchain("android-ndk-r13b-api-15-armeabi-v7a-neon-cxx14", 'Unix Makefiles'),
    Toolchain("android-ndk-r13b-api-15-x86", 'Unix Makefiles'),
    Toolchain("android-ndk-r13b-api-15-x86-cxx14", 'Unix Makefiles'),
    Toolchain("android-ndk-r13b-api-21-x86-64", 'Unix Makefiles'),
    Toolchain("android-ndk-r13b-api-21-x86-64-cxx14", 'Unix Makefiles'),
    Toolchain("android-ndk-r13b-api-21-arm64-v8a", 'Unix Makefiles'),
    Toolchain("android-ndk-r13b-api-21-arm64-v8a-cxx14", 'Unix Makefiles'),
    Toolchain("android-ndk-r13b-api-15-armeabi", 'Unix Makefiles'),
    Toolchain("android-ndk-r13b-api-15-armeabi-cxx14", 'Unix Makefiles'),
    ...
    Toolchain('android-ndk-r21d-api-16-armeabi-v7a-neon-clang', 'Unix Makefiles'),
    Toolchain('android-ndk-r21d-api-16-x86-clang', 'Unix Makefiles'),
    Toolchain('android-ndk-r21d-api-19-armeabi-v7a-neon-clang', 'Unix Makefiles'),
    Toolchain('android-ndk-r21d-api-19-x86-clang', 'Unix Makefiles'),
    Toolchain('android-ndk-r21d-api-21-arm64-v8a-clang', 'Unix Makefiles'),
    Toolchain('android-ndk-r21d-api-21-x86-64-clang', 'Unix Makefiles'),
    ...
    Toolchain('ohos-sdk-native-armeabi-v7a', 'Unix Makefiles'),
    Toolchain('ohos-sdk-native-arm64-v8a', 'Unix Makefiles'),
    Toolchain('ohos-sdk-native-x86-64', 'Unix Makefiles'),
]
...
if os.name == 'nt':
  toolchain_table += [
      ...
      Toolchain(
          'vs-16-2019', 'Visual Studio 16 2019', arch='x86', vs_version='16'
      ),
      Toolchain(
...
if platform.system() == 'Linux':
  toolchain_table += [
      ...
      Toolchain('linux-gcc-arm', 'Unix Makefiles'),
      ...
      Toolchain('linux-gcc-aarch64-lp64', 'Unix Makefiles'),
      Toolchain('linux-gcc-jetson-tk1', 'Unix Makefiles'),
      Toolchain('hisi-himix100', 'Unix Makefiles'),
      Toolchain('hisi-himix200', 'Unix Makefiles'),
      Toolchain('hisi-v300', 'Unix Makefiles'),
      Toolchain('hisi-v500', 'Unix Makefiles'),
      Toolchain('hisi-v600', 'Unix Makefiles'),
      Toolchain('hisi-v610', 'Unix Makefiles'),
      Toolchain('allwinner-r16', 'Unix Makefiles'),
      Toolchain('allwinner-r328', 'Unix Makefiles'),
      Toolchain('rockchip-px3se', 'Unix Makefiles'),
      Toolchain('rockchip-rk356x', 'Unix Makefiles'),
      Toolchain('rockchip-rk3399k', 'Unix Makefiles'),
      Toolchain('rockchip-rv1126_rv1109', 'Unix Makefiles'),
      Toolchain('novatek-24kec', 'Unix Makefiles'),
      Toolchain('ingenic-camera', 'Unix Makefiles'),
      Toolchain('raspberrypi-bcm2837', 'Unix Makefiles'),
      Toolchain('neoway-mdm9607', 'Unix Makefiles'),
      Toolchain('linaro-v7-3-1-arm', 'Unix Makefiles'),
      Toolchain('linaro-v7-3-1-armhf', 'Unix Makefiles'),
      Toolchain('linaro-v7-3-1-aarch64-linux-gnu', 'Unix Makefiles'),
      Toolchain('linaro-v5-5-0-arm', 'Unix Makefiles'),
      Toolchain('linaro-v5-5-0-armhf', 'Unix Makefiles'),
      Toolchain('linaro-v5-5-0-aarch64-linux-gnu', 'Unix Makefiles'),
      Toolchain('linaro-v4-9-4-arm', 'Unix Makefiles'),
      Toolchain('linaro-v4-9-4-armhf', 'Unix Makefiles'),
      Toolchain('gokeic-sgks6802', 'Unix Makefiles'),
      Toolchain('alios-api-4-armhf', 'Unix Makefiles'),
      Toolchain('alios-api-4-arm64', 'Unix Makefiles'),
      Toolchain('alios-api-4-x86_64', 'Unix Makefiles'),
      Toolchain('myir-am335x', 'Unix Makefiles')
  ]
...
if platform.system() == 'Darwin':
  toolchain_table += [
      ...
      Toolchain('ios-nocodesign-11-3', 'Xcode', ios_version='11.3', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-11-3', 'Xcode', ios_version='11.3', nocodesign=True),
      Toolchain('ios-nocodesign-11-3-i386', 'Xcode', ios_version='11.3', nocodesign=True),
      ...
      Toolchain('ios-nocodesign-dep-8-0-cxx14', 'Xcode', nocodesign=True),
      Toolchain('ios-nocodesign-dep-9-0-cxx14', 'Xcode', nocodesign=True),
      Toolchain('ios-nocodesign-11-4', 'Xcode', ios_version='11.4', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-11-4', 'Xcode', ios_version='11.4', nocodesign=True),
      Toolchain('ios-nocodesign-11-4-i386', 'Xcode', ios_version='11.4', nocodesign=True),
      Toolchain('ios-nocodesign-12-0', 'Xcode', ios_version='12.0', nocodesign=True),
      Toolchain('ios-nocodesign-12-0-i386', 'Xcode', ios_version='12.0', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-12-0', 'Xcode', ios_version='12.0', nocodesign=True),
      Toolchain('ios-nocodesign-12-1', 'Xcode', ios_version='12.1', nocodesign=True),
      Toolchain('ios-nocodesign-12-1-i386', 'Xcode', ios_version='12.1', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-12-1', 'Xcode', ios_version='12.1', nocodesign=True),
      Toolchain('ios-nocodesign-12-2', 'Xcode', ios_version='12.2', nocodesign=True),
      Toolchain('ios-nocodesign-12-2-i386', 'Xcode', ios_version='12.2', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-12-2', 'Xcode', ios_version='12.2', nocodesign=True),
      Toolchain('ios-nocodesign-12-4', 'Xcode', ios_version='12.4', nocodesign=True),
      Toolchain('ios-nocodesign-12-4-i386', 'Xcode', ios_version='12.4', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-12-4', 'Xcode', ios_version='12.4', nocodesign=True),
      Toolchain('ios-nocodesign-13-0', 'Xcode', ios_version='13.0', nocodesign=True),
      Toolchain('ios-nocodesign-13-0-i386', 'Xcode', ios_version='13.0', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-13-0', 'Xcode', ios_version='13.0', nocodesign=True),
      Toolchain('ios-nocodesign-13-1', 'Xcode', ios_version='13.1', nocodesign=True),
      Toolchain('ios-nocodesign-13-1-dep-8-0', 'Xcode', ios_version='13.1', nocodesign=True),
      Toolchain('ios-nocodesign-13-1-dep-9-0', 'Xcode', ios_version='13.1', nocodesign=True),
      Toolchain('ios-nocodesign-13-1-i386', 'Xcode', ios_version='13.1', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-13-1-dep-8-0', 'Xcode', ios_version='13.1', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-13-1', 'Xcode', ios_version='13.1', nocodesign=True),
      Toolchain('ios-nocodesign-13-2', 'Xcode', ios_version='13.2', nocodesign=True),
      Toolchain('ios-nocodesign-13-2-i386', 'Xcode', ios_version='13.2', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-13-2', 'Xcode', ios_version='13.2', nocodesign=True),
      Toolchain('ios-nocodesign-13-4', 'Xcode', ios_version='13.4', nocodesign=True),
      Toolchain('ios-nocodesign-13-5', 'Xcode', ios_version='13.5', nocodesign=True),
      Toolchain('ios-nocodesign-13-6', 'Xcode', ios_version='13.6', nocodesign=True),
      Toolchain('ios-nocodesign-13-7', 'Xcode', ios_version='13.7', nocodesign=True),
      Toolchain('ios-nocodesign-14-0', 'Xcode', ios_version='14.0', nocodesign=True),
      Toolchain('ios-nocodesign-14-1', 'Xcode', ios_version='14.1', nocodesign=True),
      Toolchain('ios-nocodesign-14-2', 'Xcode', ios_version='14.2', nocodesign=True),
      Toolchain('ios-nocodesign-14-3', 'Xcode', ios_version='14.3', nocodesign=True),
      Toolchain('ios-nocodesign-14-4', 'Xcode', ios_version='14.4', nocodesign=True),
      Toolchain('ios-nocodesign-14-5', 'Xcode', ios_version='14.5', nocodesign=True),
      Toolchain('ios-nocodesign-15-0', 'Xcode', ios_version='15.0', nocodesign=True),
      Toolchain('ios-nocodesign-15-2', 'Xcode', ios_version='15.2', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-13-4', 'Xcode', ios_version='13.4', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-13-5', 'Xcode', ios_version='13.5', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-13-6', 'Xcode', ios_version='13.6', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-13-7', 'Xcode', ios_version='13.7', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-14-0', 'Xcode', ios_version='14.0', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-14-1', 'Xcode', ios_version='14.1', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-14-2', 'Xcode', ios_version='14.2', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-14-3', 'Xcode', ios_version='14.3', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-14-4', 'Xcode', ios_version='14.4', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-14-5', 'Xcode', ios_version='14.5', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-15-0', 'Xcode', ios_version='15.0', nocodesign=True),
      Toolchain('ios-nocodesign-nobitcode-15-2', 'Xcode', ios_version='15.2', nocodesign=True),
      Toolchain('ios-nocodesign-13-4-i386', 'Xcode', ios_version='13.4', nocodesign=True),
      Toolchain('ios-nocodesign-13-5-i386', 'Xcode', ios_version='13.5', nocodesign=True),
      Toolchain('ios-nocodesign-13-6-i386', 'Xcode', ios_version='13.6', nocodesign=True),
      Toolchain('ios-nocodesign-13-7-i386', 'Xcode', ios_version='13.7', nocodesign=True),
      Toolchain('ios-nocodesign-14-0-i386', 'Xcode', ios_version='14.0', nocodesign=True),
      Toolchain('ios-nocodesign-14-1-i386', 'Xcode', ios_version='14.1', nocodesign=True),
      Toolchain('ios-nocodesign-14-2-i386', 'Xcode', ios_version='14.2', nocodesign=True),
      Toolchain('ios-nocodesign-14-3-i386', 'Xcode', ios_version='14.3', nocodesign=True),
      Toolchain('ios-nocodesign-14-4-i386', 'Xcode', ios_version='14.4', nocodesign=True),
      Toolchain('ios-nocodesign-14-5-i386', 'Xcode', ios_version='14.5', nocodesign=True),
      Toolchain('ios-nocodesign-15-0-i386', 'Xcode', ios_version='15.0', nocodesign=True),
      Toolchain('ios-nocodesign-15-2-i386', 'Xcode', ios_version='15.2', nocodesign=True),
      ...
      Toolchain('osx-10-14-cxx14', 'Xcode', osx_version='10.13'),
      ...
      Toolchain('osx-11-0-dep-10-10', 'Xcode', osx_version='11.0'),
      Toolchain('osx-11-1', 'Xcode', osx_version='11.1'),
      Toolchain('osx-11-1-dep-10-10', 'Xcode', osx_version='11.1'),
      Toolchain('osx-11-2', 'Xcode', osx_version='11.2'),
      Toolchain('osx-11-2-dep-10-10', 'Xcode', osx_version='11.2'),
      Toolchain('osx-11-3', 'Xcode', osx_version='11.3'),
      Toolchain('osx-11-3-dep-10-10', 'Xcode', osx_version='11.3'),
      Toolchain('osx-12-0', 'Xcode', osx_version='12.0'),
      Toolchain('osx-12-0-dep-10-10', 'Xcode', osx_version='12.0'),
      Toolchain('osx-12-1', 'Xcode', osx_version='12.1'),
      Toolchain('osx-12-1-dep-10-10', 'Xcode', osx_version='12.1'),
      Toolchain('linux-gcc-x64', 'Unix Makefiles'),
      Toolchain('unix-osx-11-1-dep-10-10', 'Unix Makefiles'),
  ]
...
if os.name == 'posix':
  toolchain_table += [
      ...
      Toolchain('gcc-linux', 'Unix Makefiles'),
      Toolchain('gcc-linux-cxx14', 'Unix Makefiles'),
