...
if(DEFINED POLLY_OSX_11_2_CMAKE_)
  return()
else()
  set(POLLY_OSX_11_2_CMAKE_ 1)
endif()

include("${CMAKE_CURRENT_LIST_DIR}/utilities/polly_init.cmake")

set(OSX_SDK_VERSION "11.2")
...
set(CMAKE_OSX_DEPLOYMENT_TARGET "11.2" CACHE STRING "OS X Deployment target" FORCE)
