...
if(DEFINED POLLY_ALIOS_API_4_ARM64_V8A_)
  return()
else()
  set(POLLY_ALIOS_API_4_ARM64_V8A_ 1)
endif()

include("${CMAKE_CURRENT_LIST_DIR}/utilities/polly_init.cmake")

polly_init(
    "AliOS API 4 arm64-v8a / gcc / c++11 support"
    "Unix Makefiles"
)
...
if(_has_errors)
  polly_fatal_error(
      "AliOS api 4 arm64-v8a Toolchain configuration failed:"
      ${_error_msg}
  )
endif()

set(NDK_ROOT "$ENV{ALIOS_HOME}")
set(CROSS_COMPILE_TOOLCHAIN_PREFIX "aarch64-linux-gnueabi")
set(CROSS_COMPILE_TOOLCHAIN_PATH "$ENV{ALIOS_HOME}/standalone/yunos-4-arm64/bin")
set(CROSS_COMPILE_SYSROOT "$ENV{ALIOS_HOME}/standalone/yunos-4-arm64/sysroot")
