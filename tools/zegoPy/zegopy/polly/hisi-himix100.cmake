# Copyright (c) 2020, zego.im
# All rights reserved.

if(DEFINED POLLY_HISI_MIX100_LINUX_)
  return()
else()
  set(POLLY_HISI_MIX100_LINUX_ 1)
endif()

include("${CMAKE_CURRENT_LIST_DIR}/utilities/polly_init.cmake")

polly_init(
    "himix100 / gcc / neon / 16-bit thumb / c++11 support"
    "Unix Makefiles"
)
...
if(_has_errors)
  polly_fatal_error(
      "HIMIX100 Toolchain configuration failed:"
      ${_error_msg}
  )
endif()
...
set(CROSS_COMPILE_TOOLCHAIN_PREFIX "arm-himix100-linux")
set(CROSS_COMPILE_TOOLCHAIN_PATH "$ENV{HISI_HOME}/arm-himix100-linux/bin")
set(CROSS_COMPILE_SYSROOT "$ENV{HISI_HOME}/arm-himix100-linux/target")
...
polly_status_print("*** set flags for 360 driving recorder ***")
...
set(
    ...
    -Wno-date-time
    -L"$ENV{HISI_HOME}/arm-himix100-linux/lib"
    -I"$ENV{HISI_HOME}/arm-himix100-linux/include"
    )
