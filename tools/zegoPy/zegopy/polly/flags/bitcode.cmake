...
if("${IOS_VARIANT}" STREQUAL "DEVICE" OR "${IOS_VARIANT}" STREQUAL "")
  polly_status_debug("Enable bitcode for iOS ${IOS_VARIANT}")
  # Only enable bitcode for device variant
  ...
  polly_status_debug("Do not enable bitcode for iOS ${IOS_VARIANT}")
endif()
