...
if(DEFINED POLLY_IOS_NOCODESIGN_15_0_CMAKE_)
  return()
else()
  set(POLLY_IOS_NOCODESIGN_15_0_CMAKE_ 1)
endif()
...
set(IOS_DEPLOYMENT_SDK_VERSION "9.0") # Xcode 13 does not support iOS 8.0 anymore
